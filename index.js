...
//DB_KEY=yJ1zrlNmbWNm5gOb


// connect to mongoDB


const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_KEY}@cluster0.wzxk65v.mongodb.net/?retryWrites=true&w=majority`;
console.log(uri)
...
app.listen(port, ()=>{
    console.log(`User management Server is running on ${port}`)
})
